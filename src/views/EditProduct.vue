        ...
        <div class="container">
          ...
          <div class="content">
              ...
              <div class="user-details">
                  ...
                  <input disabled type="text" placeholder="Enter the product name" v-model="productName" required>
                  </div>
                  <div class="input-box">
              ...
              <div class="button">
                  <input id="cancel" type="submit" v-on:click="cancel()" value="Cancel">
                  <input id="edit" type="submit" v-on:click="verify()" value="Edit Product">
              </div>
          </div>
        </div>
        <footer>
      ...
      export default {
        ...
        data() {
          return {
            ...
            productName: useProductStore().ProductSelected[1],
            price: useProductStore().ProductSelected[5],
            quantity: useProductStore().ProductSelected[6],
            ...
            axios.put(path, {
              ...
              .then((res) => {
                if(res.data.length!=0){
                  if(res.data['message'] === "Product details updated successfully!"){
                      this.msg = "Product details added successfully!";
                      this.$router.push('/sell')
                  }
                  else{
                    this.msg = "Product details have not been updated! Please try again.";
                  }
                }
              })
              .catch((error) => {
