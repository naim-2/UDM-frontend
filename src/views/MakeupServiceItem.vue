...
export default{
  ...
  methods: {
    ...
    chosenProduct(product) {
        ...
        this.$router.push(`/makeupservices/${product[1]}`)
    },
    signout(){
...
<template>
  ...
  <div id="navigation">
    ...
    <RouterLink to='/makeupservices' target="_parent"><button id="activated2">Makeup Services</button></RouterLink>
